      ...
      <div class="container" responsive>
        ...
        <div class="collapse navbar-collapse " id="navegacion-fm">
          <ul class="nav navbar-nav">      
            ...
            <li class="active"><a href="menu_principal.php"><span class="glyphicon glyphicon-circle-arrow-left"></span> REGRESAR</a></li>
...
<ul class="nav nav-pills nav-stacked" align="center">
          ...
          <div align="center">
         <img class="img-responsive" src="img/construccion2.jpg" alt="test">
