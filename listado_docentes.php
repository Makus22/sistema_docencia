...
while($personal=mysql_fetch_array($resultado))
{
...
echo "<td>$personal[0]<td/>";
echo "<td>$personal[1] $personal[2]<td/>";
//echo "<td>$personal[2]<td/>";
echo "<td>$personal[3]<td/>";
echo "<td>$personal[4]<td/>";
echo "<td>$personal[5]<td/>";
...
echo "<td> <a href='detalles.php?ci_per=$personal[2]' class='btn btn-success btn-xs'>DETALLES</a> <a href='modificar_docente1.php?ci_per=$personal[2]' class='btn btn-warning btn-xs'>MODIFICAR</a>
<a href='borrar_docente.php?ci_per=$personal[2]' onclick='return confirmar()' class='btn btn-danger btn-xs'>ELIMINAR</a><td/>";
echo "</tr>";
