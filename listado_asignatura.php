...
<body>
  ...
  <header>
   <!--<nav class="navbar navbar-default navbar-fixed-top" role="navigation"> -->
      ...
      <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">ASIGNATURA
...
<div class="container">
<div class="row">
  <div class="col-xs-4 col-sm-4 col-md-6 col-lg-6"><a href="#" class="btn btn-success" data-toggle="modal" data-target="#myModal">NUEVA ASIGNATURA <span class="glyphicon glyphicon-plus-sign"></a></span></div>
...
<form method="post" action="insertar_asignatura.php" name="formulario" id="formulario">


<div class="row">
<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
<div class="form-group">
    <label for="textfield">CÓDIGO ASIGNATURA:</label> <br>
    <input type="text" name="cod_asig" value="" class="form-control" minlength="6" maxlength="6" required pattern="[A-Za-0-9]+" placeholder="" title=" - SIGA EL EJEMPLO"  /><span class="help-block">EJEMPLO (214A01).</span>
    </div></div>


<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
<div class="form-group">
<label>DESCRIPCIÓN ASIGNATURA:</label>
<input type="text" class="form-control" name="desc_asig" id="desc_asig" minlength="1" maxlength="30" required pattern="[A-Za-zñÑáéíóúÁÉÍÓÚüÜ ]+"  placeholder="" title=" - SOLO INGRESE LETRAS" ><span class="help-block">EJEMPLO (MATEMÁTICA).</span>
</div></div></div>
...
//sentencia SQL
$sql="SELECT * FROM asignatura where bandera=1";
// es un puntero
...
echo "<td> <a href='#?cod_asig=$prueba[0]' class='btn btn-warning btn-xs'>MODIFICAR</a>
<a href='borrar_asignatura.php?cod_asig=$prueba[0]' onclick='return confirmar()' class='btn btn-danger btn-xs'>ELIMINAR</a><td/>";
echo "</tr>";
