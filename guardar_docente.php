      ...
      <div class="container" responsive>
        ...
        <div class="collapse navbar-collapse " id="navegacion-fm">
          <ul class="nav navbar-nav">
            ...
            <li><a href="listado_docentes_busqueda.php"><span class="glyphicon glyphicon-circle-arrow-left"></span> LISTADO PROFESORES</a></li>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <p align="center"><strong>INGRESE DATOS DEL DOCENTE</strong></p>
    ...
    <input type="email" name="email_profe" value="" class="form-control" minlength="11" maxlength="30" required pattern="/^([a-zA-Z0-9_\.\.es\.net\-\+])+\@(([a-zA-Z0-9\-])+\.)+([a-zA-Z0-9]{2,4})+$/" placeholder="EJEMPLO (abcd@gmail.com)" title=" - IN (@ y .com)">
    </div>
