...
<body>
  ...
  <header>
   <!--<nav class="navbar navbar-default navbar-fixed-top" role="navigation"> -->
      ...
      <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">PERIODO (LAPSO)
...
<div class="container">
<div class="row">
  <div class="col-xs-4 col-sm-4 col-md-6 col-lg-6"><a href="#" class="btn btn-success" data-toggle="modal" data-target="#myModal">NUEVO LAPSO <span class="glyphicon glyphicon-plus-sign"></a></span></div>
    ...
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
        <div class="modal-header modal-md">
          ...
          <h4 class="modal-title">NUEVO LAPSO</h4>
        </div>
        <div class="modal-body">
          <p></p>

          
<form method="post" action="insertar_lapso.php" name="formulario" id="formulario">
<div class="row">
<div class=" col-xs-12 col-sm-12 col-md-12 col-lg-12">
<div class="form-group">
<label>LAPSO (P- S-):</label>
<input type="text" class="form-control" name="cod_lapso" id="cod_lapso" minlength="1" maxlength="30" required pattern="[A-Za-z0-9ñÑáéíóúÁÉÍÓÚüÜ\,\.\- ]+"  placeholder="" title=" - " ><span class="help-block">EJEMPLO (P-2018 - S-2018).</span>
</div></div>
...
//sentencia SQL
$sql="SELECT * FROM lapso where bandera=1";
// es un puntero
...
echo "<td> <a href='#?id_lapso=$prueba[0]' class='btn btn-warning btn-xs'>MODIFICAR</a>
<a href='borrar_lapso.php?id_lapso=$prueba[0]' onclick='return confirmar()' class='btn btn-danger btn-xs'>ELIMINAR</a><td/>";
echo "</tr>";
