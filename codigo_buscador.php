...
setInterval( "window.location.reload()" ,910000);
</script>
</head>
<body>
  ...
  <header>
   <!--<nav class="navbar navbar-default navbar-fixed-top" role="navigation"> -->
      ...
      <li class="active"><a href="1buscador.php">REGRESAR</a></li>
...
if(count($buscame)==0)
{
echo "<div align='center'><h2>NO HAY RESULTADO EN LA BUSQUEDA </h2><br />";
}else{
...
echo "<div align='center'><h2>HORARIO DOCENTE</h2> <br/>";
...
<form name="form" action="repo_completo.php" method="get">
<input type="submit" name="ci_per" class="form-control" value="IMPRIMIR" class="btn btn-warning btn-md">
</body>
</html>