  ...
  <header>
   <!--<nav class="navbar navbar-default navbar-fixed-top" role="navigation"> -->
     ...
     <li class="active"><a href="menu_principal.php">INICIO</a></li>
      ...
      <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">CARRERAS
...
<div class="container">
<div class="row">
  <div class="col-xs-4 col-sm-4 col-md-6 col-lg-6"><a href="#" class="btn btn-success" data-toggle="modal" data-target="#myModal">NUEVA CARRERA <span class="glyphicon glyphicon-plus-sign"></a></span></div>
...
<form method="post" action="insertar_carrera.php" name="formulario" id="formulario">
<h4 align="center"> NUEVA CARRERA </h4><br>

<div class="row">
<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
<div class="form-group">
    <label for="textfield">CÓDIGO:</label> <br>
    <input type="text" name="cod_carre" value="" class="form-control" minlength="1" maxlength="3" required pattern="[A-Za-0-9]+" placeholder="" title=" - EL CODIGO DE PENSUM"  /><span class="help-block">EJEMPLO (INF).</span>
    </div><br></div>
...
<input type="text" class="form-control" name="des_carre" id="des_carre" minlength="1" maxlength="30" required pattern="[A-Za-zñÑáéíóúÁÉÍÓÚüÜ ]+"  placeholder="" title=" - SOLO INGRESE LETRAS" ><span class="help-block">EJEM. (INFORMÁTICA).</span>
</div></div>
...
<div class="form-group">
<label>TÍTULO:</label>
<input type="text" class="form-control" name="titulo_carre" id="titulo_carre" minlength="1" maxlength="30" required pattern="[A-Za-zñÑáéíóúÁÉÍÓÚüÜ/. ]+"  placeholder="" title=" - SOLO INGRESE LETRAS"><span class="help-block">(T.S.U INFORMATICA).</span>
</div></div></div>
...
<input type="date"  class="form-control" name="fech_ini" id="fech_ini" minlength="3" maxlength="20" required pattern="/^([a-zA-Z0-9_\.\.es\.net\-\+])+\@(([a-zA-Z0-9\-])+\.)+([a-zA-Z0-9]{2,4})+$/" placeholder="EJEMPLO (Ing. - Tsu. - Lcdo. - Lcda )" title=" - DATOS INCORRECTOS">
</div>
...
<input type="date"  class="form-control" name="fech_fin" id="fech_fin" minlength="3" maxlength="20" required pattern="/^([a-zA-Z0-9_\.\.es\.net\-\+])+\@(([a-zA-Z0-9\-])+\.)+([a-zA-Z0-9]{2,4})+$/" placeholder="EJEMPLO (MATEMATICA - INFORMATICA - SISTEMAS )" title=" - DATOS INCORRECTOS">
</div>
</div>
</div>
...
//sentencia SQL
$sql="SELECT * FROM carreras where bandera=1";
// es un puntero
...
echo "<td> <a href='#?cod_carre=$prueba[0]' class='btn btn-warning btn-xs'>MODIFICAR</a>
<a href='borrar_carreras.php?cod_carre=$prueba[0]' onclick='return confirmar()' class='btn btn-danger btn-xs'>ELIMINAR</a><td/>";
echo "</tr>";
