...
<div class="container">
<div class="row">
  <div class="col-xs-4 col-sm-4 col-md-6 col-lg-6"><a href="#" class="btn btn-success" data-toggle="modal" data-target="#myModal">AGREGAR HORARIO <span class="glyphicon glyphicon-plus-sign"></a></span></div>
    ...
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form method="post" action="insertar_horario.php" name="formulario" id="formulario">

<div class="row">
<div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6">
<div class="form-group">
<label>ID HORA:</label>
<input type="text" class="form-control" name="id_hora" id="id_hora" minlength="3" maxlength="3" required pattern="[0-9]+"  placeholder="" title=" INGRESE SOLO NÚMEROS " ><span class="help-block">EJEMPLO 001.</span>
</div></div> 
...
<input type="text" class="form-control" name="pos" id="pos" minlength="1" maxlength="2" required pattern="[0-9]+"  placeholder="" title=" SOLO NÚMERICO "><span class="help-block">POSICIÓN DE LA HORA (1 AL 20).</span>
</div></div></div>
...
<input type="time"  class="form-control" name="inicio" id="inicio" minlength="1" maxlength="20" required pattern="/^([a-zA-Z0-9_\.\.es\.net\-\+])+\@(([a-zA-Z0-9\-])+\.)+([a-zA-Z0-9]{2,4})+$/" placeholder="" title=" - SELECCIONE LA HORA ">
</div>
...
<input type="time"  class="form-control" name="fin" id="fin" minlength="1" maxlength="20" required pattern="/^([a-zA-Z0-9_\.\.es\.net\-\+])+\@(([a-zA-Z0-9\-])+\.)+([a-zA-Z0-9]{2,4})+$/" placeholder="" title=" - SELECCIONE LA HORA  ">
</div>
</div>
...
<div class="form-group">
<label>TURNO:</label><select type="text" name="turno" id="turno" class="form-control" minlength="1" maxlength="2" required pattern="/^([a-zA-Z0-9_\.\.es\.net\-\+])+\@(([a-zA-Z0-9\-])+\.)+([a-zA-Z0-9]{2,4})+$/" placeholder=""  title=" - SELECCIONE EL TURNO ">
<option>M </option>
<option>T </option>
<option>N </option>
...
echo "<td><a href='modificar_hora.php?id_hora=$prueba[0]' class='btn btn-warning btn-xs'>MODIFICAR</a>
<a href='borrar_hora.php?id_hora=$prueba[0]' onclick='return confirmar()' class='btn btn-danger btn-xs'>ELIMINAR</a><td/>";
echo "</tr>";
